...
// import { updateServiceCategory } from "../../User_Management/features/userSlice";
import { Link, useNavigate } from "react-router-dom";

const EditServiceCategory = ({ setExpand, setActiveTab }) => {
    // setExpand("marketPlace");
    setActiveTab("serviceCategoryManagement");
    const head = "Edit Service Category";
    ...
    const handleSubmit = (event) => {
        ...
        formData.append("homeCrod_serviceCategory", title);

        // dispatch(updateServiceCategory(formData));
        navigate('/home/serviceCategory')
    };
