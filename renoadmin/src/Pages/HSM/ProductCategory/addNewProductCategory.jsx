...
// import { addNewProductCategory } from "../../User_Management/features/userSlice";
import { Link, useNavigate } from "react-router-dom";

const AddNewProductCategory = ({ setExpand, setActiveTab }) => {
    // setExpand("marketPlace");
    setActiveTab("productCategoryManagement");
    ...
    const handleSubmit = (event) => {
        ...
        formData.append("prod_productCategory", title);

        // dispatch(addNewProductCategory(formData));
