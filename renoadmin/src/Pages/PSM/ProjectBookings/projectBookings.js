            ...
            <div className="fixed flex flex-col top-0 left-0 w-screen h-screen bg-gray-800 bg-opacity-50 flex justify-center items-center z-50">
              <div className="w-50 h-50 bg-white p-8 rounded-3xl">
                ...
                <div className="flex gap-4">
                  <div style={{ maxHeight: '22rem' }} className="max-w-sm flex scrollbar-hide flex-col gap-3  overflow-auto">
                    <img src="https://th.bing.com/th/id/OIP.otBKS2Z14l7A5n1CB_Mn6AEsCo?pid=ImgDet&rs=1" className="w-full rounded-md h-auto" alt="" />
                    <img src="https://th.bing.com/th/id/OIP.otBKS2Z14l7A5n1CB_Mn6AEsCo?pid=ImgDet&rs=1" className="w-full rounded-md h-auto" alt="" />
                    <img src="https://th.bing.com/th/id/OIP.otBKS2Z14l7A5n1CB_Mn6AEsCo?pid=ImgDet&rs=1" className="w-full rounded-md h-auto" alt="" />
                  </div>
                  <div style={{ width: '1.5px', backgroundColor: 'green', height: '21rem', }} className="my-auto"></div>
                ...
                <div className="flex flex-row gap-10 pt-10 w-full justify-between">
                  <button
